  ...
  return (
    <>
      <div className="our-values-page">
        <div className="our-values-page__row">
            ...
            <div className="col-2">
              ...
              <div className="row row-grid">
                ...
                <div>
                  ...
                  <p>
                    ...
                    knowledge and experience in the power and energy sector as
                    it is our duty to perform to the highest standards of
              ...
              <div className="row row-grid">
                <div>
                  ...
                  <p>
                    ...
                    competent professionals who always come together with
                    workable approach and advice to deliver optimum solutions to
                    our numerous client problems and quires.
                  </p>
                </div>
                <div>
              ...
              <div className="row row-grid">
                ...
                <div>
                  <h1>Innovation</h1>
                  <p>
                    We thrive on creativity and ingenuity which makes us to
                    stand out in our service delivery as power and energy is the
                    bedrock of industrialization and being a dynamic field of
                    endeavor and the sector being on a fast paced technological
                    climate, innovative ideas, concepts, and these processes are
                    very essential to the continued success and growth of
                    Whitewaters Engineering Limited.
                  </p>
                </div>
              </div>
              <br />
              <div className="row row-grid">
                <div>
                  <h1>Excellence</h1>
                  <p>
                    Our drive for professional excellence ensures that our
                    clients receive the finest quality of service as we pursue
                    to provide impeccable execution and delivery of our products
                    and services.
                  </p>
                </div>
                <div>
