          ...
          <div className="col-3__card card1">
            <div>
              ...
              <p>
                ...
                clients, community and profession. Ethics, fairness, honesty and
                integrity remains the cornerstone of our practice.
              </p>
            </div>
            <div>
          ...
          <div className="col-3__card card2">
            <div>
              ...
              <p>
                ...
                knowledge and experience in the power and energy sector as it is
                our duty to perform to the highest standards of professionalism
                as dictated by the local and International professional code of
                ethics.
              </p>
            </div>
            <div>
          ...
          <div className="col-3__card card3">
            <div>
              ...
              <p>
                ...
                professionals who always come together with workable approach
                and advice to deliver optimum solutions to our numerous client
                problems and quires.
              </p>
            </div>
            <div>
          ...
          <div className="col-3__card card6">
            <div>
              ...
              <p>
                ...
                honor our commitment to clients and each other. We take
                ownership of our work and promptly refine any erring to the
                greatest extent possible.
              </p>
            </div>
            <div>
              <img src={image6} alt="accountability" className="image image6" />
            </div>
          </div>
        </div>
      </div>
